...
for (let i = 0; i < 10; i++) { // Cambia 10 por la cantidad de objetos que desees
    let x = Phaser.Math.Between(300, 5900);
    let y = Phaser.Math.Between(100, 500);
    let objectType = Phaser.Math.Between(1, 3); // Determinar qué tipo de objeto
    ...
    object.scale = 0.5; // Ajusta el tamaño como desees
}
