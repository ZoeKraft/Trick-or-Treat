export default class Goal {
    constructor(scene, x, y) {
        this.scene = scene;
        this.sprite = scene.physics.add.image(x, y, 'goal');
    ...
    reachGoal() {
        const winText = this.scene.add.text(this.scene.cameras.main.width / 2, this.scene.cameras.main.height / 2, "¡Has ganado!", {
            fontSize: '40px',
            fill: '#ff0'
        }).setOrigin(0.5);
        ...
        // Reiniciar el juego después de un delay
